...
//    		space.addStaticShape( shape );
    ...
    update : function( delta ) { 
    	...
    	if(MW.CUR_GAME_STATUS === MW.GAME_STATUS.GAME_IN){
    		for(var i=0;i<this.obstaclePool.length;i++){
    			var o = this.obstaclePool[i];
    			if(cc.rectContainsRect(o.getBoundingBox(),this.flappyBird.getBoundingBox())){
    				//gameover
    				this.gameOver();
    			}
    		}
...
//        return;
    ...
    resetObstacle:function(dt){
        ...
        obstacle2.y = -random * obstacle2.height * 0.67;
        obstacle1.y = obstacle2.y + obstacle2.height + 150;
